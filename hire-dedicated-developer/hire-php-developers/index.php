...
<section class="homeBanner">
   <div class="container">
      <div class="row flex-md-row-reverse">
         <div class="col-lg-6">
            <div class="img">
               <img src="images/hire-php-developers-banner.webp" alt="Hire PHP Developers"
                  class="img-fluid" />
               <div class="imgText">
                  <div class="imgBox">
         ...
         <div class="col-lg-6">
            <div class="text">
               ...
               Hire PHP developers from top-notch web application development company trusted by 93% of CTO. We have strong expertise in all major frameworks like Laravel, CakePHP, Yii, CodeIgniter,etc</h3>
   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-sm-6 col-lg-3">
            <div class="box">
               <span>
                  <object data="images/icons/php-migration-and-module-development.svg" type="image/svg+xml"></object>
               </span>
         ...
         <div class="col-sm-6 col-lg-3">
            <div class="box">
               <span>
                  <object data="images/icons/php-site-maintenance-and-support.svg"
      ...
      <div id="accordion">
         <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
               <div class="card-body">
                  <p>
                  PHP is a general-purpose language that can be used to develop interactive and dynamic websites. PHP can store, edit, and delete information in database which makes is stronger foundation for creating web applications like eCommerce, gaming apps, community portals, etc.
                  </p>
               </div>
            </div>
         </div>
         <div class="card">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
               <div class="card-body">
                  <p>
                  You must have come across many articles that ask 'PHP is Dead?'. And the answer is No. It has been holding a dominant place as the backbone of 83% of websites. Have a look at this article to know more.</p>
               </div>
            </div>
         </div>
         <div class="card">
         ...
         <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
               <div class="card-body">
                  <p>There are n number of companies worldwide that promise to deliver efficient web applications. But you must consider the following points while opting for the best PHP web development company:</p>
                  <ul class="mb-2">
                  ...
                  <p>For Reference: <a href="https://eluminoustechnologies.com/blog/web-stories/outsourcing-software-development-company/" target="_blank">Webstory</a></p>
               </div>
            </div>
         </div>
         <div class="card">
            ...
            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
               <div class="card-body">
                  <p>MVC separates your business logic from your presentation layer. CodeIgniter is an easy-to-use PHP MVC framework that can reduce the time spent developing applications and allows to for faster-go-to-market.</p>
               </div>
            </div>
         </div>
      </div>
