...
<section class="homeBanner">
   <div class="container">
      <div class="row flex-md-row-reverse">
         <div class="col-lg-6">
            <div class="img">
               <img src="images/hire-dedicated-developers.webp" alt="Hire Dedicated Developers" class="img-fluid" />
               <div class="imgText">
                  <div class="imgBox">
         ...
         <div class="col-lg-6">
            <div class="text">
               ...
               <h3 class="subSubTitle">
                  Get access to the <b>Top 1% of the talented development team</b> elected to meet your project needs.
                  Hire
                  dedicated developers who are sourced and screened from extensive vetting process and ready to work for
      ...
      <div class="row justify-content-center">
         ...
         <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="box">
               ...
               <p>
                  Hire dedicated developers to quickly scale up the team and easily ramp down once your work gets done.
               </p>
            </div>
         </div>
         <div class="col-sm-6 col-lg-4 col-xl-3">
      ...
      <div class="row justify-content-center">
         <div class="col-lg-10 text-center">
            ...
            <p class="subTitle">Software outsourcing has never been so easy ! We can help you to hire skilled
               Developers, Testers, Business Analysts and Technology Architects as per your need in optimum time. This
               will help you to accelerate software development, reduce cost and nitty-gritties of hiring best talent.
            </p>
         </div>
      </div>
      <div class="bottomWrapper">
         <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4 d-flex">
               <div class="box">
                  <span><object data="images/icons/fast-quick-onboarding.svg" type="image/svg+xml"></object></span>
                  <h3 class="title">Pizza PODs</h3>
                  <ul>
                     <li>Hire specialists in development or testing who will faciliate to your existing POD or software
                        team</li>
                     <li>Flexibility of hiring specialists on need basis saves significant cost and reduce talent risk
                     </li>
                  </ul>
               </div>
            </div>
      ...
      <div id="accordion">
         <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
               <div class="card-body">
                  <p>
                     When you hire dedicated developers, what you get is comprehensive expertise in one place with
                     reputation and maximum commitment. In the case of freelancing, there is a little bit of insecurity
                     about above-mentioned points. With hire dedicated development model you can easily ramp-up and ramp
         ...
         <div class="card">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
               <div class="card-body">
                  <p>
                     If you want to hire dedicated developers full-time, then it will cost you in between $2400 to $4000
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
               <div class="card-body">
                  <p>
                     ...
                     software development projects can hire dedicated developers to get their work done in systematic
                     approach.
                  </p>
               </div>
            </div>
         ...
         <div class="card">
            <div class="card-header" id="headingFive">
               <h5 class="mb-0">
                  <button class="btn-link collapsed" data-toggle="collapse" data-target="#collapseFive"
                     ...
                     What is your resource backup strategy? If my existing resource is unavailable due to some emergency
            ...
            <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
               <div class="card-body">
                  <p>Don't worry. We have a pool of 130+ developers and we always take care of mandatory provisions for
         ...
         <div class="card">
            ...
            <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
               <div class="card-body">
                  <p>Be assured. It will never happen as we choose our resources carefully. Still, if you are unhappy we
                     shall be sharing an escalation process. You can share your concern with our Account manager and
                     Delivery managers. We shall replace the resource as soon as possible. Generally, when we onboard a
                     new resource, our Seniors pay close attention and ensure you a timely and quality outcome.
                     According to the business scenario or any reason all parties have the right to give 30 days' notice
         ...
         <div class="card">
            ...
            <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
               <div class="card-body">
                  <p>We provide time overlapping between clients' timezone (GMT/CST/PST/EST) and eLuminous teams. Time
                     overlapping will allow smooth communication between stakeholders and assured quality work and
                     on-time delivery.</p>
               </div>
            </div>
         </div>
