...
<section class="inner_banner">
	...
	<div class="inner_page_title">
		<div class="container">
			...
			<small> Childcare Jobs Listings</small></h1>
		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/childcare/childcare.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					<b>Business problem:</b> Early years careers website users had to open the website on their mobile browser and then view the listing for jobs related to childcare. Though the website was responsive, the client wanted to reach out to the young generation who is using mobile phones for almost all of their searches and give them an opportunity to build their careers.
					</small>
					<small>
					<b>Solution in brief:</b> Childcare Jobs Listing is an application that offers childcare job listing from the UK, like Nursery practitioner, childminders, nannies, nursery managers, apprentices, qualified EYFS teachers and much more. Searching & getting jobs for the same is made simple & easy with the help of this mobile application.
					</small>
					</h6>
					...
					<div class="tech_use_port">
						...
						<div class="scrool_expertise text-left">
							<a href="http://play.google.com/store/apps/details?id=com.earlyyearscareers.edwyn" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
						</div>
					</div>
