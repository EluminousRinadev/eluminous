		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/trtcle/trtcle.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/trtcle/trtcle2.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/trtcle/trtcle3.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/trtcle/trtcle4.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/trtcle/trtcle5.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6><small>The Client, TRTCLE is a organization dedicated to providing high quality continuing legal education. TRTCLE has grown to be one of the leaders in online CLE.</small>
					<small>The client wanted to build the website to gain an online presence over the web to educate legal professionals online. We have developed a robust eLearning platform for legal professionals along with PCI Compliance.</small>
					</small>
					</h6>
                         <ul class="p_listing">
					...
					<div class="scrool_expertise text-left">
						<a href="https://www.trtcle.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
				</div>
			</div>
		</div>
