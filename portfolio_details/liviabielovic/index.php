		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/liviabielovic/liviabielovic.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/liviabielovic/liviabielovic2.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/liviabielovic/liviabielovic3.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/liviabielovic/liviabielovic4.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>portfolio_details/liviabielovic/liviabielovic5.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					 Livia Bielovic is a very popular model from South Africa. We have designed a portfolio for her which allows people to check the modeling assignments that she had done in past, present & coming future. This website is built using a ‘then’ latest version of Drupal which is Drupal.
					</small>
					</h6>
                         <ul class="p_listing">
					...
					<div class="scrool_expertise text-left">
						<a href="http://liviabielovic.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
