			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/jean-patrique/Voucher-Sites-of-Dealmonster.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/jean-patrique/Voucher-Sites-of-Dealmonster2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/jean-patrique/Voucher-Sites-of-Dealmonster3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/jean-patrique/Voucher-Sites-of-Dealmonster4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/jean-patrique/Voucher-Sites-of-Dealmonster5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<small>This is an ecommerce site, where people purchase different types of products.</small>
                         <small>Payment Gateways integrated with Sage pay & PayPal. This Site is also integrated with different type of promotions such as X% Off, X Amount Off, Free Shipping, etc.</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.jean-patrique.co.uk/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
