		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/icmarkets/icmarkets.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/icmarkets/icmarkets2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/icmarkets/icmarkets3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/icmarkets/icmarkets4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/icmarkets/icmarkets5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>This website is made for Australian client whose main business is forex Trading. Users can make funding and withdrawals through the site. Also Brokers can join clients business by applying online. Users/Visitors can get education of Forex & CFD’s on the site. Website has questionnaire which tests client’s knowledge about CFD & Forex Trading</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.icmarkets.com.au/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
