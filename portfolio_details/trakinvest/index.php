		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/trakinvest/trakinvest.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/trakinvest/trakinvest1.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/trakinvest/trakinvest2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/trakinvest/trakinvest3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/trakinvest/trakinvest4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>The client wanted us to develop the website for the virtual trading platform. TrackInvest is the world's first social investment platform for equities. User is provided with virtual currency and account for trading. Internships, contests, and TrakPRO fund manager.</small>
					</h6>                         
                         <ul class="p_listing">
					...
					<h6>Client Benefits :</h6>
						<ul>	
					<li> We built a one-stop solution for online trading, which helped the client reduce operating costs while boosting overall profit margins.</li>	
					<li>We developed a virtual trading platform that enabled users to trade online using social media networks, which helped the client widen their reach.</li> 
					</ul>


					<div class="scrool_expertise text-left">
						<a href="http://www.trakinvest.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
