		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class=" ">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/bellavetro/bellavetro.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					We worked on Bellavetro design optimization so that it will work on latest mobile devices & tabs with different resolution.
					Users can send an enquiry to the admin regarding the design/work and admin will create a user, send message through message thread for an inquiry, then users will pay 40% amount of work as Down payment and remaining 60% as the final amount.
					</small>
					<small>We have integrated the PayPal payment gateway to collect the inquiry payments. Admin can mark inquiry as "Closed" or can re-open it anytime. We have integrated the language translation plugin in this website.</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://eluminousdev.com/bellavetro/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
