		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/afri-tunes/afrik.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					<b>Business problem:</b> AfrikTunes website users had to open the website on their mobile browser and then view and listen to the songs, which was not convenient to access from a mobile screen.
					</small>
					<small>
					<b>Solution in brief:</b>  AfrikTunes mobile application is developed to provide an access to the radio service to the African music. It allows the users to listen to their favorite artist’s music on the phones using mobile application. Searching and listening to music is so much of fun now.
					</small>
					</h6>
