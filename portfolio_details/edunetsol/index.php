		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class=" ">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/edunetsol/edunetsol2020.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>
					Edu-Net app helps the major stakeholders related to the school to have effective communication to preserve transparency in the flow of communication. The client wanted us to build an application to eliminate communication issues between the stakeholders and maintain clarity in the flow of information.
					</small>
					</h6>
					<ul class="p_listing">
				...
				<ul>
					<li>We conceptualized the product as SaaS, which enabled the client to service multiple schools while keeping costs and complexity under control. </li>
					<li>We designed an intuitive and user-friendly UI for the web and mobile apps, which helped the product's users easily work with large amounts of school data.</li>
					<li>We incorporated a real-time tracking functionality in the ERP, which enabled all stakeholders to remain updated automatically.</li>
				</ul>
					<div class="scrool_expertise text-left">
						<a href="http://edunetsol.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
