		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/linkbridge/linkbridge.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/linkbridge/linkbridge2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/linkbridge/linkbridge3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/linkbridge/linkbridge4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/linkbridge/linkbridge5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					This website mainly offers the online seminars and courses. For accessing it, users need to register on the site with an initial fee which can be paid using the highly secured PayPal which is integrated into the system. The Blog section is added separately on the website so that the users can view the blog contents and comment the same. We have also integrated a Photo & video gallery on the website for user’s perusal.
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://linkbridge.com.au/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
