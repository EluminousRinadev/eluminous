		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/grooming/grooming.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/grooming/grooming2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/grooming/grooming3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/grooming/grooming4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/grooming/grooming5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					This application is built for one of our client based in Sweden who had a requirement to develop two websites (grooming.se &amp; beauty.se) with single admin panel to manage everything like products, orders etc. The website “grooming.se” sells beauty products for Men while “beauty.se” has beauty products for Woman. It has various online payment options like PayPal, Klarna, COD (Cash on Delivery) for customer’s convenience. 
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="https://www.grooming.se/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
