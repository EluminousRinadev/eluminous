		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/razerzone/razerzone.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/razerzone/razerzone2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/razerzone/razerzone3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/razerzone/razerzone4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/razerzone/razerzone5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>This ecommerce website was developed for the well-known brand Razer, where they can sell their product online.</small>
                         <small>People can purchase product from this platform by online payment. This platform has Add to cart, compare, and other facility for users.</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.razerzone.com/ " target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
