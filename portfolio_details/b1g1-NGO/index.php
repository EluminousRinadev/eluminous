		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/b1g1-NGO/businessforgood.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/b1g1-NGO/businessforgood2.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/b1g1-NGO/businessforgood3.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/b1g1-NGO/businessforgood4.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/b1g1-NGO/businessforgood5.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>B1G1 is a social enterprise and non-profit organization with a mission to create a world full of giving. It helps small- and medium-sized businesses achieve more social impact by embedding giving activities into everyday business operations and creating unique giving stories. The Client wanted to revamp their website as it take a long time to load.</small>
					<small>It makes the user leave the website in the middle of the process.</small>
					</h6>
					<ul class="p_listing">
