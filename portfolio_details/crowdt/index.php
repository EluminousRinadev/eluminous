		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/crowdt/crowdt.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/crowdt/crowdt2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/crowdt/crowdt3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/crowdt/crowdt4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/crowdt/crowdt5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					This is an e-commerce website which has a large number of t-shirts on sale. We have designed a custom template through which the admin can create campaigns, authorize and capture payment, and calculate the price of T-shirts based on colors used for selling purpose.
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.crowdt.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
