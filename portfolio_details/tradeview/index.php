		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class=" ">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/tradeview/tradeview.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
					</div>
				</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					The site is developed for a trading investment client who provides information regarding trading and investments. There is also a client area, where the user can check on their details. The client area is developed in core PHP. The user can purchase any programs from the website and admin confirms and provide access to on the programs. The user can view the program details, logging to the client area.
					</small>
					<small>PayPal payment gateway is integrated with the website for purchase. Zoho is integrated to insert leads when a new user registers. YouTube video API is used to display videos and playlists for registered users.</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.tradeview.com.au/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
