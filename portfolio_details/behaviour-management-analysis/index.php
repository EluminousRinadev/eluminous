		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/behaviour-management-analysis/behaviour-management-analysis.png" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>The Client wanted us to develop an application to manage the behavioral record of the patients including the current medications, diet, and everything.</small>
					<small>Behaviour Management Analysis (B.M.A) is a real-time record keeping mobile application that allows a carer or care team to record valuable information about an individual’s behavior. It also captures information about their surroundings, interactions, dietary information, and medication.</small></h6> 
					...
					<ul>
						<li>We segregated patient data using Amazon Web APIs, which helped the client manage patients' records easily.</li>
						<li>We developed a behavioural management system that enabled real-time record-keeping to observe the behavioral statistics of a patient.</li> 
					</ul>
					<div class="scrool_expertise text-left">
						<a href="https://play.google.com/store/apps/details?id=com.behaviourrecordanalysis" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
