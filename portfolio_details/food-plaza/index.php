		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/food-plaza/food-plaza.png" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<small>Looking for a place to dine or unwind? Food Plaza will help you out.
                         ...
                         <ul class="p_listing">
                         	<h6 class="mb-4">Key features:</h6>                         	
                              <li>Find your restaurant Choose by category, proximity or by name and scroll through restaurants.</li>
                              <li>Find out open hours, get their phone number and get directions with live map. Receive offers from nearby restaurants The app will search for offers and let you know if it finds anything. If you are looking actively, you can use our hungry search to receive instant deals from
						nearby restaurants.</li>
                              <li>Save your favorites If you find a good place, make sure to save it. Whenever you find something interesting, add it to your list of favorites for easy access or when you feel like eating out but are out of ideas.</li>
                         </ul>
					...
					<div class="scrool_expertise text-left">
						<a href="https://play.google.com/store/apps/details?id=com.food.plaza" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
