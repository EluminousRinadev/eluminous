		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/firstcolorado/firstcolorado.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/firstcolorado/firstcolorado2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/firstcolorado/firstcolorado3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/firstcolorado/firstcolorado4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/firstcolorado/firstcolorado5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					The requirement was to create a Wordpress website for Realtor. The website will be responsible for creating traffic on the site. 
					</small>
					</h6>
                         
                         <ul class="p_listing">
                              <li>Integrated a dsIDx plugin which will show properties from IDX.</li>
                              <li>Used Buildium API: By using buildium API tenants and Landlords are redirected to their particular login pages.</li>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.firstcolorado.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
