		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/cnmarketing/cnmarketing.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/cnmarketing/cnmarketing2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/cnmarketing/cnmarketing3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/cnmarketing/cnmarketing4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/cnmarketing/cnmarketing5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					We have designed this website for our partners and one of the known Internet marketing & Web development firm in South Africa-CN Marketing. This website is developed in Joomla using the Rocket theme. The users can view the services offered by the company, check their past projects, find out different ideas about digital marketing and can set a callback, or can check their contact details and blog written by the users.
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="https://cnmarketing.co.za/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
