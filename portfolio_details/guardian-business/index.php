		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/guardian-business/guardian-business.png" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>Guardian Business mobile app will be a reporting tool for the employee against any kind of abuse, violence, discomfort they are facing in office.</small>
                         <small>This app will provide the employee with a facility to register with the app, raise ticket against ill things happening in the office. The clause of anonymity will be considered in the app development by sending/raising the ticket using a masked email address that is created at the time of employee registration.</small>
                         <small>The app will allow employees to anonymously report transgressions of fellow employees to employers and allow employers to disseminate information to all employees simultaneously.</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="https://play.google.com/store/apps/details?id=com.theguardian.business" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
