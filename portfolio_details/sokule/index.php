		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sokule/sokule.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sokule/sokule2.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sokule/sokule3.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sokule/sokule4.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div> 
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sokule/sokule5.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					Sokule offers services like a free website and web 2.0 Social media applications to help members in promoting their websites. Every post pings the weblogs and reaches multiple targeted social media platforms. It is fully integrated with all leading social networks (Facebook, Twitter, Linkedin etc.). You can even post on 80+ social sites and blogs in just one click. 
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="http://www.sokule.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
