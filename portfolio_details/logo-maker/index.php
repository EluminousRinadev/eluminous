		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/logo-maker/logo-maker.png" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>The client wanted us to build a Logo Maker app for the iOS platform. Logo Maker is the easiest app to create logo on your iPhone, iPad, and iPod. Create stunning logos, icons, symbols, posters in just a few clicks. </small>					
					</h6>

					<div class="portfolio-reviews-details">
						<strong><p>Over Millions of downloads and 66K+ Reviews</p></strong>
					</div>
...
<h6>Client Benefits :</h6>	
					<ul>
						<li>Logomaker helps the customers to create their business logos by themselves within no time.</li>
						<li>Provided subscription method helps users to use the specific features based on the plans.</li>
						<li>Developed a backend dashboard that includes revenue earned from an application.</li>
					</ul>
					<div class="scrool_expertise text-left">
						<a href="https://apps.apple.com/us/app/logo-maker-create-a-design/id1143390028" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
