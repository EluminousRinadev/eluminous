		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/stratgrowportal/stratgrowportal.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
					</div>
				</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center pt-5 pb-5">
					...
					<h6>Description:<br>
					<small>
					Startgrow is the website for a project, leads &amp; sales management for the client. It is made easy to manage all the activities for the admin on real-time basis &amp; get updates on status related to it.
					</small>
					</h6>
					...
					<ul class="p_listing">
						...
						<li>Display reports related to projects which get added by admin using GTMatrix, Raven tools, Quickbooks, Google analytics.</li>
					...
					<div class="scrool_expertise text-left">
						<a href="http://stratgrowportal.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
