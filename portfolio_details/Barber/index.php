		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/Barber/Barber.jpg" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					<b>Business problem:</b> People had to call the barber/beautician shop to book their appointment. It was very difficult for them to book an appointment for barber/beautician/technician of their choice through the phone.
					</small>
					<small>
					<b>Solution in brief:</b> We have developed a mobile app for Barber and Beauticians. This application allows the Beauty shops to sell their employee’s expert services to the users who use this app. It will allow the users to search for shops, their employees and book appointments, mark as favorite and view their booked appointment details and cancel them if required.
					</small>
					</h6>
