		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="slider-for">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/club-bookers/club-bookers.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/club-bookers/club-bookers1.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/club-bookers/club-bookers2.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/club-bookers/club-bookers3.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/club-bookers/club-bookers4.jpg" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>
					<small>The Club Bookers Team lets you and your friends have a great night out in the most prestigious and exclusive nightclubs in London. The client wanted us to build a centralized booking system for the famous clubs in London including the facility to alter the list of the clubs.</small>
					</h6>
					<ul class="p_listing">
					...
					<h6>Client Benefits :</h6>
						<ul>	
					<li>We designed and developed a centralized booking system, which made it easier for the client to manage all club bookings. </li>	
					<li>We conceptualized and built a dynamic pricing system that records and analyzes all bookings, which boosted revenue by helping the client optimize club booking prices in peak season.</li> 
					</ul>

					<div class="scrool_expertise text-left">
						<a href="https://club-bookers.com/" target="_blank" class="small_blue_btn blue_big_btn_scrool">Launch website</a>
					</div>
