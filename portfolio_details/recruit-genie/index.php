...
<section class="inner_banner">
	<img src="<?php echo SITE_URL;?>images/portfolios/portfolio_banner_details.jpg" alt="main_banner_bg" class="img-fluid" loading="lazy">
		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/recruit-genie/recruit-genie.png" alt="image"  draggable="false"/ class="img-fluid" loading="lazy">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>An employee communication app that directly links with the Recruit Genie HR platform. Employees can communicate directly with managers and colleagues, manage their training, view and apply for vacancies, carry out staff reviews, view company news, staff benefits and much more. </small>
					...
					<div class="scrool_expertise text-left">
						<a href="https://play.google.com/store/apps/details?id=com.recruit.genie" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
