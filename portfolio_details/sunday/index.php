		...
		<div class="row justify-content-between">
			...
			<div class="col-md-7">
				<div id="photo-slider">
					<div class="">
						<div class="item">
							<img src="<?php echo SITE_URL;?>/portfolio_details/sunday/sunday-streams.png" alt="image"  draggable="false"/ class="img-fluid">
						</div>
			...
			<div class="col-md-5 gray_bg d-flex align-items-center ">
				<div class="project_details align-self-center">
					...
					<h6>Description:<br>
					<small>
					<b>Business problem:</b> Sometimes people cannot visit the church due to many possible reasons, but they wish if they could view the live/archives streams of a respective church from their current location.</small>
					<small>
					<b>Solution in brief:</b> We have built Sunday streams mobile application. Using this application, user can watch the live and archive video streams of different church on their mobile.
					</small>
					</h6>
					...
					<div class="scrool_expertise text-left">
						<a href="https://play.google.com/store/apps/details?id=com.imd.sunday_stream&hl=en" target="_blank" class="small_blue_btn blue_big_btn_scrool">Get it on</a>
					</div>
