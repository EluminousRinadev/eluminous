					...
					<div class="left_section">
						<div class="form-row">
							<div class="col-md-12">
								<div class="input_white_bg">
									...
									<input type="text" class="form-control" id="homePageName" placeholder="Your name *" value="" required>
								</div>
						...
						<div class="form-row row">
							<div class="col-md-6 col-xs-6 col-lg-6">
								<div class="input_white_bg">
									<span><img src="<?php echo SITE_URL; ?>images/contact/your_email.webp" alt="your_email"></span>
									<input type="text" class="form-control" id="homePageEmail" placeholder="Email Address *" required>
								</div>
								<div class="contact-form-error-message">
							...
							<div class="col-md-6 col-xs-6 col-lg-6">
								<div class="input_white_bg justify-content-start text-left">
									<span><img src="<?php echo SITE_URL; ?>images/contact/mobile_number.webp" alt="mobile_number"></span>
									<input type="text" class="form-control" onkeydown="return checkPhoneKeyHome(event.key)" id="homePageMobile" name="homePageMobile" placeholder="Cell Number " required maxlength="15">
						...
						<div class="form-row">
							<div class="col-md-12">
								<div class="input_white_bg textarea_box">
									<textarea type="text" class="form-control" id="homePageBriefProjectInformation" placeholder="Project Details" required></textarea>
								</div>
								<div class="contact-form-error-message">
								...
								<div class="col-md-12 col-xs-12 col-lg-12">
									<div class="row align-items-center">
										<div class="col-xs-12 col-sm-4 col-md-6 col-lg-4 pl-0 mobile-space mt-sm-0">
											...
											<input type="text" class="change-design form-control" id="cptchaQues" readonly name="cptchaQues" value="<?php echo $newCptcha; ?>"></div>
									...
									<div class="form-row privacy_policy mt-3 ml-0">
										<div class="row align-items-center">
											...
											We respect your privacy. <a href="/privacy-policy" target="_blank">*Privacy Policy</a>
										</div>
									</div>
									<div class="text-right align_mobile_sec">
										<div class="row">
											<button type="button" id="homePageSubmit" class="small_blue_btn">Submit</button>
										</div>
									</div>
								</div>
							</div>
