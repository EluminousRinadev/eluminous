            ...
            <div class="contacts_number">
              ...
              <ul>
                <li>
                  ...
                  <img src="<?php echo SITE_URL;?>images/contact/india_flag.jpg" alt="UK flag icon" width="21">  +91 253 238 2566</a>
          ...
          <div class="main_box_top">
            ...
            <div class="menu_heigh_box">
              ...
              <ul class="sub_menu">
                ...
                <li <?php if($pagename1 == 'Data Analytics &amp; BI') { echo 'class="active"'; } ?>><a href="data-analytics-and-bi">Data Analytics &amp; BI</a></li> 
                 <li <?php if($pagename1 == 'dedicated-developer') { echo 'class="active"'; } ?>><a href="dedicated-developer">Hire Dedicated Developers</a></li> 
              </ul>
            </li>
