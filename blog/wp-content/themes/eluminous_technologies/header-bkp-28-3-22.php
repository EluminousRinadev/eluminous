						...
						<div class="whatsapp_wrapper d-flex flex-row">
							<div class="call_us_today">
								...
								<p class="hide" id="usCode"><img src="<?php echo SITE_URL;?>images/contact/usa_flag.jpg" alt="USA flag icon" width="21">
									...
									<p class="hide" id="inCode"><img src="<?php echo SITE_URL;?>images/contact/india_flag.jpg" alt="UK flag icon" width="21">
							...
							<div class="menu_wrapper">
								<div class="logo">
									<a href="<?php echo SITE_URL;?>">
										...
										<img src="<?php echo SITE_URL;?>images/19-years.png" alt="eluminous-pvt-ltd 19 years" class="img-fluid sixtnyears">
									</a>
								</div>
								<div class="get_wrapper">
									<ul class="mobile">
										<li class="get_quote_btn" id="pop-up-btn">
											<a href="<?php echo SITE_URL;?> contact_us" id="get-quote" data-ccw="get-quote">Get a Quote</a>
										</li>
									</ul>
									<div id="nav-icon">
										<span></span>
...
<!--                   <li class="dropdown_menu">
                ...
                <li <?php if($pagename1 == 'dedicated-developer') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>dedicated-developer">Hire Dedicated Developer</a></li>
