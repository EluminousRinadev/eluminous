        ...
        <div class="container">
          <div class="row justify-content-between whatsapp_wrapper">
            <ul class="contacts_email">
              <li>
                <a href="mailto:<?php echo $headerEmail ?>" class="desktop"><i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $headerEmail; ?></a>
                <a href="mailto:<?php echo $headerEmail ?>" class="mobile"><i class="fa fa-envelope" aria-hidden="true"></i></a>
              </li>
            </ul>
              <div class="call_us_today">
                <p class="hide" id="zaCode"><img src="<?php echo SITE_URL;?>images/contact/south_africa_flag.png" alt="UK flag icon" width="21"> +27 16 423 1893</p>
                ...
                <p class="hide" id="inCode" style="display: block;"><img src="<?php echo SITE_URL;?>images/contact/india_flag.jpg" alt="UK flag icon" width="21">
          ...
          <div class="main_box_top">
            <div class="menu_wrapper">
              <div class="logo">
                <a href="<?php echo SITE_URL;?>">
                 <img src="<?php echo SITE_URL;?>images/eluminous-pvt-ltd_black.png" alt="eluminous-pvt-ltd_black" class="img-fluid logo_elu">
                   <img src="<?php echo SITE_URL;?>images/17-years.png" alt="eluminous-pvt-ltd 17 years" class="img-fluid sixtnyears">  
                </a>
              </div>
              <div class="get_wrapper">
                <ul class="mobile"><li class="get_quote_btn" id="pop-up-btn">
                  <a href="<?php echo SITE_URL;?>contact_us.php">Get a Quote</a></li>
                </ul>
                <div id="nav-icon">
                  <span></span>
                  <span></span>
            ...
            <div class="menu_heigh_box">
              <ul class="menu float-right">
                ...
                <li class="dropdown_menu <?php if($pagename == 'about-us') { echo 'active'; } ?>"><a href="#">About Us</a>
                <ul class="sub_menu">
                  <li class="" <?php if($pagename1 == 'about-us') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>about-us.php">Our company</a></li>
                  <li class="" <?php if($pagename1 == 'engagement-models') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>engagement-models.php">Engagement Models</a></li>
                  <li class="" <?php if($pagename1 == 'career') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>career.php">Careers</a></li>
              ...
              <li class="dropdown_menu <?php if($pagename == 'services') { echo 'active'; } ?>"><a href="#">Services</a>
              <ul class="sub_menu">
                <li class="active" <?php if($pagename1 == 'web-application-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>web-application-development.php">Web Development</a></li>
                <li <?php if($pagename1 == 'mobile-app-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>mobile-app-development.php">Mobile Apps Development</a></li>
                <li class="" <?php if($pagename1 == 'front-end-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>front-end-development.php">Front End Development</a></li>
             <li <?php if($pagename1 == 'Data Analytics &amp; BI') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>data-analytics-and-bi">Data Analytics &amp; BI</a></li>  
                                 <li <?php if($pagename1 == 'dedicated-developer') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>dedicated-developer">Hire Dedicated Developers</a></li>
              </ul>
            </li>
            ...
            <li class=" <?php if($pagename == 'portfolio') { echo 'active'; } ?>"><a href="<?php echo SITE_URL;?>portfolio.php">Portfolio</a></li>
            <li class=" <?php if($pagename == 'Blog') { echo 'active'; } ?>"><a href="<?php echo SITE_URL;?>blog/" >Blog</a></li>
            <li class=" <?php if($pagename == 'Contact') { echo 'active'; } ?>"><a href="<?php echo SITE_URL;?>contact.php">Contact Us</a></li>
            <li class="get_quote_btn desktop" id="pop-up-btn">
              <a href="<?php echo SITE_URL;?>contact.php">Get a Quote</a></li>              
            </ul>
          </div>
        </div>
      </div>
