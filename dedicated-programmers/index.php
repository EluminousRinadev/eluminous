...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" itemprop="keywords" content="front end Developer, back end developer, mobile app developers, hire php developer, hire mobile app developers, hire php programmers" />   

    <meta name="description" itemprop="description" content="Hire Front End Developers, Back End Developers From eLuminous Having 14+ Years of Experience In IT Industry. Get A Higher Credibility, Brand Value And Guaranteed On-Time Delivery Of Projects With Us." />
...
a.src=document.location.protocol+"//script.crazyegg.com/pages/scripts/0049/9383.js?"+Math.floor(new Date().getTime()/3600000);
...
a.async=true;a.type="text/javascript";b.parentNode.insertBefore(a,b)}, 1);
  ...
  <body>
    ...
    <div class="col-md-4 col-xs-9 logo"><a href="#home-sticky-wrapper"><img src="img/new-img/logo.png" alt="eluminous"></a></div>
    ...
    <header class="jumbotron bg-inverse" role="banner">
      ...
      <div class="col-md-6 header-text" style="padding-top:0;">
        ...
        <h2 class="m-b-3">And get a higher credibility, brand value and guaranteed on-time delivery of projects with us.</h2>
				 ...
				 ?>
                  ...
                  <!-- <p>
                   ...
                   <p>
                     ...
                     <input type="submit" onclick="_gaq.push(['_trackEvent', 'DedicatedCategory', 'DedicatedAction', 'dedicatedLable',5]);" class="button" id="mc-embedded-subscribe" name="btn_submit_1" value="Next">
				 ...
				 ?>
                   ...
                   <p>
                    ...
                    <p>
                     ...
                     <input type="submit" onclick="_gaq.push(['_trackEvent', 'DedicatedCategory', 'DedicatedAction', 'dedicatedLable',5]);" class="button" id="mc-embedded-subscribe" name="btn_submit_2" value="START YOUR FREE TRIAL">
        ...
        <div class="row p-y-3">
          ...
          <div class="col-md-4 p-t-md wp wp-5">
            ...
            <div class="card pricing-box">
              ...
              <div class="card-block">
                ...
                <p class="card-title">The UI / UX Designer works up to 8 hours per day and 20 days in a month.</p>
              ...
              <a href="http://eluminoustechnologies.com/dedoffselectedPlan.php?price=1500.00" target="_blank" class="btn btn-primary-outline">Get Started</a>
          ...
          <div class="col-md-4 stacking-top">
            ...
            <div class="card pricing-box pricing-best p-x-0">
              ...
              <div class="card-block">
                ...
                <p class="card-title">The project engineer works up to 8 hours per day and 20 days in a month.</p>
              ...
              <ul class="list-group list-group-flush p-x">
                ...
                <li class="list-group-item">Flexible Upgrades in packages.</li>
                 ...
                 <li class="list-group-item">Technology: PHP, MySQL, Laravel, CorePHP, CodeIgnitor, Yii, NodeJS, MEAN Stack</li>

              </ul>

              <a href="http://eluminoustechnologies.com/dedoffselectedPlan.php?price=1600.00" target="_blank" class="btn btn-primary">Get Started</a>
          ...
          <div class="col-md-4 p-t-md wp wp-6">
            ...
            <div class="card pricing-box">
              ...
              <a href="http://eluminoustechnologies.com/dedoffselectedPlan.php?price=2400.00" target="_blank" class="btn btn-primary-outline">Get Started</a>
...
<!--<section id="about" class="section-text">
      ...
      <section id="portfolio">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 view-btn"><a class="viewmore" href="http://eluminoustechnologies.com/portfolio/" target="_blank">View More </a> </div>
      ...
      <div class="container">
        ...
        <div id="carousel-testimonials" class="carousel slide" data-ride="carousel" data-interval="0">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active">
              ...
              <blockquote class="blockquote">
                ...
                <p class="h3">You guys are making all the difference in the world. We had our FIRST SALE on CRM within 30 minutes of launch!!! Really happy with this progress and this CRM will be a long term project I am going to work with ELUMINOUS</p>
            ...
            <div class="carousel-item">
              ...
              <blockquote class="blockquote">
                ...
                <p class="h3">Eluminous Technologies have been instrumental in helping us develop software solutions for our clients. Eluminous are great communicators, efficient and easy to work with. They complete all tasks correctly and on time.</p>
            ...
            <div class="carousel-item">
              ...
              <blockquote class="blockquote">
                ...
                <p class="h3">It has been a pleasure working with Sukhada Deo in the last three months. Her ideas and responsiveness with customer requests have definitely exceeded our expectations. We truly appreciate her high level of technical skills. She continuously provides us with helpful advice on web design and infrastructure for some of our critical clients.</p>
            ...
            <div class="carousel-item">
              ...
              <blockquote class="blockquote">
                ...
                <p class="h3">It was really, really a pleasure to have Mukesh , online and virtually alongside me offering us his guidance, and applying changes to the website needs as and when changes were needed to be made by the client “on the fly”, given everything his else that he has to deal with.</p>
            ...
            <div class="carousel-item">
              ...
              <blockquote class="blockquote">
                ...
                <p class="h3">Just a quick message to say Thanks for all the hard work you have done so far. Really enjoying working with you and clients are really happy too with your level of design skill, and great communication skills too. Hoping for a long prosperous business relationship.</p>
          ...
          <ol class="carousel-indicators">
            ...
            <li class="active"><img src="img/new-img/user-tumb.png" alt="Navigation avatar" data-target="#carousel-testimonials" data-slide-to="0" class="img-fluid img-circle"></li>

            <li><img src="img/new-img/user-tumb.png" alt="Navigation avatar" data-target="#carousel-testimonials" data-slide-to="1" class="img-fluid img-circle"></li>

            <li><img src="img/new-img/user-tumb.png" alt="Navigation avatar" data-target="#carousel-testimonials" data-slide-to="2" class="img-fluid img-circle"></li>

            <li><img src="img/new-img/user-tumb.png" alt="Navigation avatar" data-target="#carousel-testimonials" data-slide-to="3" class="img-fluid img-circle"></li>

            <li><img src="img/new-img/user-tumb.png" alt="Navigation avatar" data-target="#carousel-testimonials" data-slide-to="4" class="img-fluid img-circle"></li>
    ...
    <section class="section-signup bg-faded ">
      ...
      <div class="col-md-7 col-lg-9">
        ...
        Hire Front End / Back End Developers who develop high-quality, user-centric and innovative Web and Mobile Apps, Business Intelligence services that deliver actual, measurable value to our clients.</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery(".yes").click(function(){	jQuery('.poup_fst').hide();
