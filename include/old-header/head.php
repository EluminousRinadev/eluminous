            ...
            <div class="container">
               <div class="row justify-content-between">
                  <ul class="contacts_email">
                     <li>
                        <a href="mailto:sales@eluminoustechnologies.com" class="desktop"><i class="fa fa-envelope" aria-hidden="true"></i> sales@eluminoustechnologies.com</a>
                        <a href="mailto:sales@eluminoustechnologies.com" class="mobile"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                     </li>
                  </ul>
                  <div class="whatsapp_wrapper d-flex flex-row">
                     <div class="call_us_today">
                        <p class="hide" id="zaCode"><img src="<?php echo SITE_URL;?>images/contact/south_africa_flag.png" alt="SA flag icon" width="21"> +27 (79)874-8495</p>
                        <p class="hide" id="ukCode"><img src="<?php echo SITE_URL;?>images/uk_flag.jpg" alt="UK flag icon" width="21"> +44 208 133 5090</p>
                        <p class="hide" id="usCode"><img src="<?php echo SITE_URL;?>images/contact/usa_flag.jpg" alt="USA flag icon" width="21">
                           <a href="tel:17188389981"> +1 718 838 9981</a></p>
                           <p class="hide" id="inCode"><img src="<?php echo SITE_URL;?>images/contact/india_flag.jpg" alt="IN flag icon" width="21">
                     ...
                     <div class="menu_wrapper">
                        <div class="logo">
                           <a href="<?php echo SITE_URL;?>">
                              <img src="<?php echo SITE_URL;?>images/eluminous-pvt-ltd_black.png" alt="eluminous-pvt-ltd" class="img-fluid logo_elu">
                        ...
                        <div class="get_wrapper">
                           <ul class="mobile">
                              <li class="get_quote_btn" id="pop-up-btn">
                                 <a href="<?php echo SITE_URL;?>contact/" id="get-quote" data-ccw="get-quote">Get a Quote</a>
                              </li>
                           </ul>
                           <div id="nav-icon">
                              <span></span>
                     ...
                     <div class="menu_heigh_box">
                        <ul class="menu float-right">
                           <li class="dropdown_menu <?php if($pagename == 'about-us') { echo 'active'; } ?>">
                              <a href="#">About Us</a>
                              <ul class="sub_menu">
                                 <li class="" <?php if($pagename1 == 'about-us') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>about-us/">Our company</a></li>
                                 <li class="" <?php if($pagename1 == 'why-us') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>why-us/">Why Us</a></li>
                                 <li class="" <?php if($pagename1 == 'engagement-models') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>engagement-models/">Engagement Models</a></li>
                                 <li class="" <?php if($pagename1 == 'career') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>career/">Careers</a></li>
                                 <li class="" <?php if($pagename1 == 'Company Brochure') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>company-brochure/" target="_blank">Company Brochure</a></li>
                              </ul>
                           </li>
                           <li class="dropdown_menu <?php if($pagename == 'services') { echo 'active'; } ?>">
                              <a href="#">Services</a>
                              <ul class="sub_menu">
                                 <li <?php if($pagename1 == 'Data Analytics &amp; BI') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>data-analytics-and-bi/">Data Analytics &amp; BI</a></li>
                                 <li ><a href="https://www.franchisorpal.com/" target="_blank">Data Analytics & BI Solution (Franchisor Pal) </a></li>
                                 <li class="active" <?php if($pagename1 == 'web-application-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>web-application-development/">Web Development</a></li>
                                 <li <?php if($pagename1 == 'mobile-app-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>mobile-app-development/">Mobile Apps Development</a></li>
                                 <li class="" <?php if($pagename1 == 'front-end-development') { echo 'class="active"'; } ?>><a href="<?php echo SITE_URL;?>front-end-development">Front End Development</a></li>
                           ...
                           <li  class="dropdown_menu  <?php if($pagename == 'dedicated-developer') { echo 'active'; } ?>">
                              <a href="#">Hire Dedicated Developer</a>
                              <ul class="sub_menu">
                                 <li class="" <?php if($pagename1 == 'hire-angular-developers') { echo 'class="active"'; } ?>>                                 
                                    <a href="<?php echo SITE_URL;?>dedicated-developer">Hire Dedicated Developer</a>
                                 </li>
                                 <li class="" <?php if($pagename1 == 'hire-angular-developers') { echo 'class="active"'; } ?>>
                                 <a href="<?php echo SITE_URL;?>hire-angular-developers">Hire Angular Developer</a></li>
                                 <li class="" <?php if($pagename1 == 'hire-reactjs-developers') { echo 'class="active"'; } ?>>
                                 <a href="<?php echo SITE_URL;?>hire-reactjs-developers">Hire ReactJS Developer</a></li>
                                 <li class="" <?php if($pagename1 == 'hire-vuejs-developers') { echo 'class="active"'; } ?>>
                                 <a href="<?php echo SITE_URL;?>hire-vuejs-developers">Hire VueJS Developer</a></li>
                              </ul>
                           </li>
                           <li  class=" <?php if($pagename == 'Hire-Dedicated-VA') { echo 'active'; } ?>">
                              <a href="https://eluminousva.com/" target="_blank">Hire Dedicated <span class="desktop-view">VA</span><span class="mobile-view">VIRTUAL ASSISTANT</span></a>
                           </li>
                           <li class=" <?php if($pagename == 'portfolio') { echo 'active'; } ?>"><a href="<?php echo SITE_URL;?>portfolio">Portfolio</a></li>
                           <li class=" <?php if($pagename == 'Blog') { echo 'active'; } ?>"><a href="<?php echo SITE_URL;?>blog" >Blog</a>
                        </ul>
                     </div>
                        ...
                        <ul class="menu">
                           <!--      <li class=" <?php //if($pagename == 'Contact') { echo 'active'; } ?>"><a href="<?php //echo SITE_URL;?>contact">Contact Us</a></li> -->
                                 <li class="get_quote_btn desktop" id="pop-up-btn">
                                    <a href="<?php echo SITE_URL;?>contact/" id="get-quote" data-ccw="get-quote" class="mt-0">Get a Quote</a> 
                                 </li>
                              </ul>
                     </div>
                  </div>
