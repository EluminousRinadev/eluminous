...
<body class="">
				...
				<ul class="contact_info">
					...
					<li class="red_btn call_contact">
						...
						if ($countryName == 'South Africa') { ?>
							<a href="tel:+27164231893" class="call_contact btn">
								<span class="call_icons icons"><img src="images/icons/call-white.png" alt="Call Icon" /></span>
								+27 16 423 1893
							</a>
						<?php } ?>
	...
	<section class="trusted_client top_client">
		<div class="container text-center">
			...
			<h2>Technologies We Serve <small class="d-block">We use the trending technologies to obtain competitive edge to business</small></h2>
				...
				<div class="col-lg-5 col-md-5 d-flex justify-content-md-end justify-content-sm-center">
					<div class="team">
						...
						<div class="team_slider owl-carousel">
							...
							<div class="box">
								<div class="image">
									<img src="images/abhilash.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Abhilash</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/ajay.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Ajay</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/arvind.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Arvind</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/asif.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Asif</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/mayur.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Mayur</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/pragati.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Pragati</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/sachin.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Sachin</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/shailesh.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Shailesh</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/swapnil.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Swapnil</h4>
							...
							<div class="box">
								<div class="image">
									<img src="images/trunal.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Trunal</h4>
									<p>Full-Stack Developer, <span><span class="fw_600">4+</span> exp</span></p>
							...
							<div class="box">
								<div class="image">
									<img src="images/vinod.jpg" alt="Pooja" class="img-fluid">
								</div>
								<div class="team_info">
									<h4>Vinod</h4>
			...
			<div class="row">
				<div class="col-lg-5">
					<div class="box">
						...
						<p>We build targeted solutions that actually work, creating powerful user experiences that will meet your business goals.</p>
						<ul class="why_laravel_list">
