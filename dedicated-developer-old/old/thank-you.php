...
<style>
	section#home_banner {
    background: url(https://eluminoustechnologies.com/frontend-development-services/images/home-banner-gradieant.png);
	...
	<div class="mb-5 mt-5 thank_you_bg" >
		<div class="container">
			<div class="text-center thank_you">
				<div class="tick_icon text-center col-12"><img src="images/check.webp" alt="thank you" class="mt-1 mb-4 img-fluid"></div>
		...
		<p class="red_btn call_contact call">
			<a href="https://eluminoustechnologies.com/hire-reactjs-developers/" class="call_contact btn scroll_form" id="quote">
				Back to Home Page
			</a>
		</p>
