...
$pageTitle = "Hire Dedicated Developers"; //Put page title here
...
<style>
    ...
    section.dedicated-developer-logos::after,
    ...
    section.hiring-process .logo-box li:hover h3,
    section.hiring-process .logo-box li:hover p {
        color: #fff;
    }
    ...
    .popup-bar .form-control::-webkit-input-placeholder {
        /* Chrome/Opera/Safari */
        color: #333;
        font-size: 12px;
        letter-spacing: 0.5px;
    ...
    .popup-bar .form-control::-moz-placeholder {
        /* Firefox 19+ */
        color: #333;
        font-size: 12px;
        letter-spacing: 0.5px;
    ...
    .popup-bar .form-control:-ms-input-placeholder {
        /* IE 10+ */
        color: #333;
        font-size: 12px;
        letter-spacing: 0.5px;
    ...
    @media (max-width: 1199px) {
        ...
        section.dedicated-developer-logos .container,
        section.hiring-process .container,
        section.dedicated-resources-wrapper .container {
            padding: 0 30px;
        }
    ...
    <div class="main-banner-wrapper">
        <div class="container">
            <div class="banner-containt">
                <h3>Hire Dedicated Developer with </br>Stress-Free Management</h3>
                ...
                <button type="button" class="blue_big_btn blue_big_btn_scrool wow fadeInDown" data-toggle="modal"
                    data-target="#exampleModal">
                    Talk to developer now!
                </button>
            </div>
            <div class="company-logo-slider">
                <a href="https://clutch.co/profile/eluminous-technologies?utm_source=widget&utm_medium=widget_2&utm_campaign=widget&utm_content=logo#summary"
                    target="_blank"> <img src="images/dedicated-developer/clutch-award.png" alt="Top Web Developers Clutch"
                        class="img-fluid" loading="lazy">
                    <div class="review-wrap">4.8 <span>14 REVIEWS</span>
                        <div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-right">
                <div class="good-firms-list">
                    <img src="images/dedicated-developer-2020/good-firms-list.png" alt="Good Firms">
                </div>
            </div>
            <div class="col-md-6">
                <div class="commen-section">
                    <h2><small>Recognized by</small>
                        Good Firms</h2>
                    <p>Utilize our decades of experience with Industry experts meets your business needs across the
                        digital landscape with their knowledge and skills</p>
                    <a href="https://www.goodfirms.co/company/eluminous-technologies-pvt-ltd" target="_blank"> <img
                            src="images/dedicated-developer-2020/good-firm.png" alt="good-firm" loading="lazy"></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="our_parthner_slider" class="owl-carousel">
                ...
                <div class="item">
                    <div class="item-wrapper">
                        ...
                        <p>Hire a team of dedicated resources with a dedicated office space and complete control over
                            the work process</p>
                    </div>
                </div>
                <div class="item">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="logo-box">
                    <ul>
                        <li><img src="images/dedicated-developer-2020/shopify.png" alt="Shopify" loading="lazy"></li>
                        <li><img src="images/dedicated-developer-2020/magento.png" alt="Magento" loading="lazy"></li>
                        <li><img src="images/dedicated-developer-2020/laravel.png" alt="Laravel" loading="lazy"></li>
                    </ul>
                    <ul>
                        <li><img src="images/dedicated-developer-2020/android.png" alt="Android" loading="lazy"></li>
                        <li><img src="images/dedicated-developer-2020/flutter.png" alt="Flutter" loading="lazy"></li>

                    </ul>
                    <ul>
                        <li><img src="images/dedicated-developer-2020/react.png" alt="React" loading="lazy"></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-7 commen-section">
                ...
                <p>We leverage various app development technologies, frameworks, platforms, and software design patterns
                    to provide cost-effective and scalable IT services and solutions that help our clients drive
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-7 commen-section">
                <h2><small>Hiring Process</small>
                    ...
                    Our Expert Resource
                    Pool</h2>
                <p>You will work with the experts who understand your business challenges, technological needs & more
                    important your work culture Empowers Valuable experience.</p>
...
<section class="dedicated-resources-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="img-box"><img src="images/dedicated-developer-2020/dotted-img.png" alt="Dots Texture Image"></div>
                <img src="images/dedicated-developer-2020/dedicated-resources-img.png" alt="Dedicated Resources With eLuminous" loading="lazy">
            </div>
            <div class="col-md-6">
                <div class="commen-section">
                    ...
                    <button type="button" class="blue_big_btn blue_big_btn_scrool wow fadeInDown" data-toggle="modal"
                        data-target="#exampleModal">Talk to developers now!</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
<div class="modal fade popup-bar" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                            ...
                            <div class="form-row m-0">
                                <div class="col-md-12">
                                    <div class="input_white_bg">
                                        <span><img src="<?php echo SITE_URL;?>images/contact/name.png" alt="name"
                                                loading="lazy"></span>
                                        <input type="text" class="form-control" id="dedicatedPageName"
                                ...
                                <div class="col-md-12">
                                    <div class="input_white_bg">
                                        <span><img src="<?php echo SITE_URL;?>images/contact/your_email.png"
                                                alt="your_email" loading="lazy"></span>
                                        <input type="text" class="form-control" id="dedicatedPageEmail"
                                ...
                                <div class="col-md-12">
                                    <div class="input_white_bg">
                                        <span><img src="<?php echo SITE_URL;?>images/contact/mobile_number.png"
                                                alt="mobile_number" loading="lazy"></span>
                                        <input type="text" class="form-control" id="dedicatedPageMobile"
                                ...
                                <div class="col-md-12">
                                    <div class="input_white_bg">
                                        <span><img src="<?php echo SITE_URL;?>images/dedicated-developer/skype.png"
                                                alt="Skype" loading="lazy"></span>
                                        <input type="text" class="form-control" id="dedicatedPageSkypeId"
                                            placeholder="Skype ID " required>
                                    </div>
                                </div>
                                <div class="col-md-12 mt-3">
                                    <div class="input_white_bg textarea_box">
                                        <textarea type="text" class="form-control" id="dedicatedMessage"
                                            placeholder="Requirement Brief" required></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-xs-12 col-lg-12 p-0 mt-3">
                                    <div class="text-right align_mobile_sec">
                                        <button type="submit" class="small_blue_btn"
                                            id="dedicatedDeveloperSubmit">Request A Quote</button>
                                    </div>
                                </div>
                            </div>
