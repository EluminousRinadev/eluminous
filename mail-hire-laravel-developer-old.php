...
//require_once('class.smtp.php');
	...
	if(isset($_REQUEST)) {
		...
		$number 			=  trim($_REQUEST['contactNo']);
	...
	//	$mail = new PHPMailer();
		...
		$mail->Password = '3D>m8WW&'; //'eLuTech#2021*hbu#98';
		$mail->SetFrom('biz@eluminoustechnologies.com','eLuminous');
		$message = '';

		$subject = 'New Enquiry: Hire Laravel Developer';	// Your Email Subject.
		...
		$message .= '<tr><td style="padding: 4px 8px;border: 1px solid #efefef;">Country</td><td style="padding: 4px 8px;border: 1px solid #efefef;">'.$country.'</td></tr>';
		$message .= '</tbody></table>';
		...
		$mail->AddAddress('sk@eluminoustechnologies.com', 'Gauri');
		$mail->AddAddress('eluminous_se42@@eluminoustechnologies.com', 'Shalaka');
		$mail->send();
		...
		$emailObject->Password = '3D>m8WW&';//'eLuTech#2021*hbu#98';
		$emailObject->SetFrom('biz@eluminoustechnologies.com','eLuminous');

		$subject = 'Thank you! We have received your request for Hire Laravel Developer';	
		$headers = "Content-Type: text/html; charset=ISO-8859-1\r\n";
