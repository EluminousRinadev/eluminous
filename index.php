    ...
    <div class="container bannerTopWrapper">
      ...
      <div class="col-md-8 col-lg-6">
          <div class="text">
            ...
            <a href="https://eluminoustechnologies.com/front-end-development/" target="_blank" class="btn small_blue_btn scroll_form btn">Get Started</a>
          </div>
        </div>
        <div class="col-md-4 col-lg-6">
          <div class="img">
            <img src="images/banner-image-top.png" alt="Front-End Development" class="img-fluid" width="" height="" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="they_believed_us">
         ...
         <div class="believed_slider">
            <div id="they_believed_us" class="owl-carousel">
               ...
               <div class="client_logo_wrapper"><img src="images/viacom_18.png" alt="Viacom 18" loading="lazy"></div>
               <div class="client_logo_wrapper"><img src="images/color.png" alt="Colors Viacom" loading="lazy"></div>
               <div class="client_logo_wrapper"><img src="images/sokule.png" alt="Sokule" loading="lazy"></div>
               <div class="client_logo_wrapper"><img src="images/mp_inovation.png" alt="Mp Inovations.inc" loading="lazy"></div>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class=" ">
         ...
         <div class="owlCarousel frameworks_slider">
            ...
            <div class="frem_work wow fadeInDown" data-wow-delay="0.6s">
               <img src="images/front_end_development/back_end/node.js.png" alt="Node js" class="img-fluid" loading="lazy">
            </div>
            ...
            <div class="frem_work wow fadeInDown" data-wow-delay="2s">
               <img src="images/front_end_development/back_end/postgresql-logo.png" alt="Postgresql" class="img-fluid" loading="lazy">
            </div>
            <div class="frem_work wow fadeInDown" data-wow-delay="2.2s">
               <img src="images/web_development/mongo-db-design.png" alt="Mongo DB" class="img-fluid" loading="lazy">
            </div>
            ...
            <div class="frem_work wow fadeInDown" data-wow-delay="2.8s">
               <img src="images/front_end_development/bootstrap_icon.png" alt="Bootstrap" class="img-fluid" loading="lazy">
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="col-12">
            ...
            <div id="testimonials_slider" class="owlCarousel">
               <div class="text-center text-white">
                  <p>"We have been developing advertising sites online for the past 19 years and for the past 10 years eLuminous has done the programming for many of them. You can see our sites and that many of them were done by eLuminous. They do great work and they are reliable and helpful."</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t1.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Jane,
                     <small>President, New york</small></span>
                  </div>
               </div>
               <div class="text-center text-white">
                  <p>"eLuminous Technologies has recently completed our first project with them. I was beyond satisfied with their attention to detail and communication. The final project was completed at the highest standard. The team was committed to ensuring that my team was completely satisfied with the project before it went live. Fantastic organisation, we have recently started our second project with them."</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t2.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Stewart,
                     <small>Project & Content Director, New Zealand</small></span>
                  </div>
               </div>
               <div class="text-center text-white">
                  <p>"I am developing a new mobile app and the team at eLuminous provided an excellent quote and delivered the product on time and did a fantastic job, thanks guys"</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t3.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Peter,
                     <small>Senior Consultant , Australia</small></span>
                  </div>
               </div>
               <div class="text-center text-white">
                  <p>"I have used eLuminous Technologies for quite sometime now, and since day one, i have been impressed with their level of professionalism and quality of delivered work. Their staff are always available and very well versed in communication skills so there isnt a language barrier."</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t4.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Miguel,
                     <small>Chief Operations Officer, South Africa</small></span>
                  </div>
               </div>
               <div class="text-center text-white">
                  <p>I am very satisfied with the service I received from eLuminous Technologies. The most trustable company I have ever seen. I appreciate their teamwork, intelligence, domain expertise which helped my business to bring it to the next level. I love eLuminous!</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t5.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Finn Goswami,
                     <small>Team Lead, Ukraine</small></span>
                  </div>
               </div>
               <div class="text-center text-white">
                  <p>"You guys are making all the difference in the world. We had our FIRST SALE on CRM within 30 minutes of launch!!! Really happy with this progress and this CRM will be a long term project I am going to work with ELUMINOUS"</p>
                  <div class="username">
                     <div class="profile_img"><img src="images/home/t6.jpg" alt="eluminous testimonials" class="img-fluid" loading="lazy"></div>
                     <span>Matt,
            ...
            <div id="our_insights" class="owl-carousel wow fadeInDown" data-wow-delay="0.4s">
               ...
               <div class="blog_wrapper">
                  ...
                  <div class="blog_contant">
                     ...
                     <a href="<?php echo $postUrl?>" target="_blank"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
