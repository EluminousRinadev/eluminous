...
';
	...
	sendmail($strEmailAddress, $adminMail,$CustmorMailsubject, $customerMailBody, $AdminfromName);
        ...
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/880466289/?label=2mOECNzPnG8Q8bLrowM&amp;guid=ON&amp;script=0"/>
        </div>
        </noscript>
...
<head>
    ...
    <meta name="keywords" itemprop="keywords" content="outsource web development, web development company in india, web developers in india, outsource web development india" />
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-custom">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="https://eluminoustechnologies.com/" target="_blank"><img src="img/logo.png" alt="eluminous logo"></a>
            ...
            <div class="telwrap"><span class="call">Toll Free: USA : </span> <a href="tel:02030564373">+1 646 688 3509</a> <div class="skype"><img src="./img/skype1.png"><a href="skype:eluminoustechnologies">eluminoustechnologies</a></div></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">                    
                    ...
                    <div class="intro-text">
                        ...
                        <span class="page-scroll"><a class="btn btn-primary" href="#themainform">Please Click Here</a></span>
    	...
    	<div class="container">
        	...
        	<div class="col-md-6 thelist">
            	...
            	<div class="row">
                	...
                	<div class="col-sm-12 mrbot50"> <img src="img/devlopment-icon.png" alt="web development icon" class="webappIcon"></div>
                ...
                <div class="col-md-6 thelrfrm">
                	...
                	<div id="themainform" class="theform">
                        ...
                        <div class="frmhead">Let’s Discuss<h2>Your Requirements</h2></div>
                        ...
                        <form action="" method="post" name="request_callback"> 
                        	...
                        	<fieldset>
                            	...
                            	<div class="form-group">
                                	...
                                	<span><input  class="form-control" required type="text" placeholder="Name" size="40" value="" name="your_name_1"></span>

                                </div>

                                <div class="form-group">

                                	<span><input class="form-control" required type="email" placeholder="Email" size="40" value="" name="your_email_address_1"></span>
                                ...
                                <div class="form-group">
                                	...
                                	<span><input class="form-control" required type="text" placeholder="Cell Number" size="40" value="" name="phone_1"></span>
	...
	<div class="container">
        ...
        <div class="row mrtop30">
          ...
          <div class="col-md-4 exblock">
            ...
            <p>Payment Processors- PayPal, AIM, 2CO, epay, Social Networking integration – Facebook, Twitter, Hi5, etc.</p>
...
<section id="earth">
  ...
  <div class="container">
    ...
    <section id="portfolio">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 text-center"><a class="viewmore" href="https://eluminoustechnologies.com/portfolio/" target="_blank">View More </a> </div>
                ...
                <div class="row items mrbot30">
                  ...
                  <div class="xpert col-md-4 col-sm-6">
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">Sachin is our Sr. Project Team Lead (Products segment) with 10 years of experience, incorporating the skills of our project managers and business analysts</div>
                  ...
                  <div class="xpert col-md-4 col-sm-6">
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">Nitin has over 10+ years of corporate experience in Project management as a developer, consultant and project leader, now managing our major corporate projects</div>
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">He has over 9+ years of experience in web &amp; mobile apps consulting. He conceptualizes the ideas of clients & help them to visualize their products.</div>
        	...
        	<div class="row item">
            	 ...
            	 <div class="xpert col-md-4 col-sm-6">
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">Shruti is an amazing innovator and an extremely detailed orientated individual. She has been a key resource to our in-house product development since its inception</div>
                  ...
                  <div class="xpert col-md-4 col-sm-6">
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">Tejal has 5 years experience in IT, excelling in programming, project management. He also has an extensive knowledge in Angular JS, jQuery and various upcoming technologies.</div>
                  ...
                  <div class="xpert col-md-4 col-sm-12">
                    ...
                    <div class="xpertwrap">
                      ...
                      <div class="xpertdesc">Asif is a perfectionist when it comes to creativity. Since joining eLuminous, he has been able to introduce a unique and incredible UI/UX within his designs</div>
    ...
    <section class="success" id="about">
        ...
        <div class="container"><div data-ride="carousel" data-interval="false" class="carousel slide col-sm-10 col-sm-offset-1 text-center" id="faqCarousel"><p></p><div role="listbox" class="carousel-inner"><div class="item"><h2>Can you help me build a concept for my app or website?</h2><p>We always take full interest in your concept, understand your business model, your competitors or reference apps and form a strategy by understanding your SWOT. Our consulting experts will then bring your idea into a framework or prototype that you like. Then our developers turn it into reality.</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div><div class="item active"><h2>How can I get in touch with the developers according to my Time zone?</h2><p>The developers are online on Gtalk, Skype &amp; other Instant Messengers. For big projects, we tweak our team’s timings depending on the client’s time zone to ensure the timings don’t crumple the “communication�? &amp; of course our “On Time Deliveries�?.</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div><div class="item"><h2>How will you manage my project?</h2><p>Based on your preferences and size of project, we choose daily status emails, Online PMS i.e. using popular time tracking and project management tools like Teamwork Basecamp, Mavenlink</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div>

                    <div class="item"><h2>What forms of payment are available?</h2><p>Our customers have the choice to pay via Bank Wire Transfer/ Bank TT, 2Checkout, Paypal with credit or debit cards.</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div><div class="item"><h2>Will my code and database be secure? Can you sign NDA?</h2><p>eLuminous has handled a large variety of sensitive information including millions of CC numbers, emails and details of your customers as well. Our business is based on strong ethical foundation and we take decisions based on highest level of ethical integrity and our core values. We welcome signing NDA (Non-Disclosure Agreement) as needed</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div><div class="item"><h2>What if I there are bugs after delivery?</h2><p>We provide 90 days FREE service from beta delivery of your application. Hence you can relax as even if any bugs arises, it won’t eat your pocket</p><div class="faqbtnwrap"><a href="#faqCarousel" role="button" class="faqbtn" data-slide="next">Next Question </a></div></div></div><h4 class="highlight">eLuminous helps you transform your thoughts into extenstible, simple &amp; perceptive technology based solution.</h4></div></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="modal-body">                           
                            ...
                            <img src="img/portfolio/mbt.jpg" class="img-responsive img-centered" alt=""></div>
                            ...
                            <a target="_blank" href="https://www.mbt.com/en-gb" role="button" class="btn btn-primary ">View Project</a>
            ...
            <div class="container">
               ...
               <div class="col-lg-12">
                        ...
                        <div class="modal-body">                           
                            ...
                            <img src="img/portfolio/trakInvest.png" class="img-responsive img-centered" alt="trakInvest"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="modal-body">                           
                            ...
                            <img src="img/portfolio/progenesisivf.jpg" class="img-responsive img-centered" alt="progenesisivf"></div>
                            ...
                            <p>his website belongs to healthcare. It is an informative site about Fertility Treatments & Procedures, Pregnancy Plan etc.</p>

                            <a target="_blank" href="https://www.progenesisivf.com/" role="button" class="btn btn-primary ">View Project</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="modal-body">                           
                            ...
                            <img src="img/portfolio/grandballroom.jpg" class="img-responsive img-centered" alt="grandballroom"></div>
                            ...
                            <p>This is an informative website for one of our client who wanted to promote their grand ballroom and its services. It’s a simple WordPress site that gives an information about the sitting arrangements and the banquet room plan of the ballroom.</p>

                            <a target="_blank" href="https://www.grandballroom.in/" role="button" class="btn btn-primary ">View Project</a>
...
jQuery('[name="btn_request_callback"]').click(function(){
   (new Image()).src="//www.googleadservices.com/pagead/conversion/880466289/?label=2mOECNzPnG8Q8bLrowM&guid=ON&script=0";
})
})
</script>
