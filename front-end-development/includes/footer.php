            ...
            function capthchaPageValidation() {
                ...
                return $("#captchaAnswer").val()
                    ...
                    : ($.ajax({
                          ...
                          success: function (e) {
                              "true" == e ? jQuery(".frontEndPageCorrectCaptcha").html("") : (jQuery(".frontEndPageCorrectCaptcha").html("Please fill correct captcha"), jQuery("#cptchaQues").val(e));
                          },
                      }),
                      !1)
...
function doSomething() {
    ...
    var day = date1.getDay();
           ...
           jQuery.ajax({
            ...
            url : checkSlot,
            data : {
                action: "check_slot", slotDate :  slotDate
            },
