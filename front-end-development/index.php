                ...
                <div class="left">
                  ...
                  <div class="reviewer common">
                    <div class="topNew">
                      ...
                      <div class="profile">
                        <div class="img">
                          <span class="img_circle"><img src="images/icons/user-profile.png" alt="user icon" /></span>
            ...
            <div class="review common">
              <div class="top">
                <div class="left">
                  <span class="project_heading">the review</span>
                  <p>
                    eLuminous dedicated a project manager to our project who had excellent communication
                    skills.
                  </p>
                  <!-- <p class="date">Dec 2, 2020</p> -->
                      ...
                      <div class="profile">
                        <div class="img">
                          ...
                          <div class="nameDetailsWrap">
                            ...
                            <span class="nameDetails">Managing Director, Web Design &amp; Development Agency</span>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="container p-0 ">
      <div class="container-fluid caseStudies weOfferSection">
        ...
        <div class="row justify-content-center caseStudiesRow">
          <div class="col-sm-6 col-lg-3 col-xl-3 d-flex">
            <div class="card">
              <span class="img frontEndIcon"><img src="images/icons/front-end.png" alt="Front-end Development" /></span>
              <h4>Front-end Development</h4>
              <p>
                Hire front-end developers with expertise in Angular, React and Vue. We use Agile methodology which
                gives
                ability for fast time-to-market. Agile-driven approach provide effective product scoping, faster
          ...
          <div class="col-sm-6 col-lg-3 col-xl-3 d-flex">
            <div class="card">
              <span class="img fullStackWebIcon"><img src="images/icons/full-stack-web.png" alt="Full Stack Web Development" /></span>
              <h4>Full Stack Web Development</h4>
              <p>
                Hire full stack developers from eLuminous Tecnologies who will work for front-end and back end of the
          ...
          <div class="col-sm-6 col-lg-3 col-xl-3 d-flex">
            <div class="card">
              <span class="img psdToBootstrapIcon"><img src="images/icons/psd-to-bootstrap.png" alt="PSD to Bootstrap Development" /></span>
              <h4>PSD to Bootstrap Development</h4>
              <p>
                Our front-end experts will help you to convert PSD to Bootstrap, PSD to HTML/CSS, PSD to WordPress,
                PSD
          ...
          <div class="col-sm-6 col-lg-3 col-xl-3 d-flex">
            <div class="card">
              <span class="img customApplicationIcon"><img src="images/icons/custom-application.png" alt="Custom Application Development" /></span>
              <h4>Custom Application Development</h4>
              <p>
                Front-end developers are here to help you in creating simple, intuitive, cross-browser compatible
        ...
        <div class="container">
          <div class="row justify-content-center caseStudiesRow">
            ...
            <div class="col-sm-6 col-lg-3 col-xl-3 d-flex">
              <div class="card white whiteBg">
                <div class="imgWrap">
                  <img src="images/ui-using-react-js.jpg" alt="Food delivery app with user friendly UI using ReactJs"
                    class="img-fluid" />
                </div>
                <div class="text">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-12 col-lg-7 col-xl-7 d-flex align-items-center">
          <div class="box">
            ...
            <h4 class="fw400">
            Get your team of front-end-developers from Clutch-rated Top 100 Web Application Development Company in 2021! 
            </h4>
      ...
      <div id="contact-form-top" class="contact-form-top">
        ...
        <form action="" method="post" class="form" id="planForm">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" maxlength="11" onkeydown="return checkPhoneKey(event.key)" name="number" id="number"
